  ...
  componentDidMount(){
    if(this.props.lists.length>0){
      ...
      for(let i = 0;i<array.length;i++){
        if((array[i].floorElement === 'RestRooms') && (array[i].Node === this.props.Node) ){
          let name = '';
          let type = '';
          let macId = '';
      ...
      <div>
        <form onSubmit={this.handleSubmit}>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="name" placeholder="Enter MAC ID" name="macId" value={this.state.macId}  onChange={this.handleInputChange} />
          </div>
          <div class="form-group">
...
export default connect(mapStateToProps,{junctionDetails,updateJunction,elementDetails})(RestRoom);